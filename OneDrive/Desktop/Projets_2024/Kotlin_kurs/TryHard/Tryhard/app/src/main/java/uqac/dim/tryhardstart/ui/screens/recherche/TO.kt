...
fun To(businessAccountViewModel: BusinessAccountViewModel,rechercheViewModel: RechercheViewModel,adminViewModel: AdminViewModel){
    ...
    val options = listOf("Montreal", "Chicoutimi", "Toronto", "Douala", "Yaounde","Berlin", "München", "Hamburg", "Frankfurt", "Köln")
    ...
    adminViewModel.villeArrive.value = selectedOptionText
        ...
        Column(
            ...
            Card(
                ...
                Row(
                    modifier = Modifier.fillMaxWidth().padding(if(modeUser)5.dp else 2.dp),
                    ...
                    Column(
                        ...
                        Text(text = "Ankunft", color = Green, modifier = Modifier.padding(start = 10.dp))
