...
var city by remember { mutableStateOf("") }
    ...
    Column(modifier = Modifier
        ...
        Row(modifier = Modifier
            ...
            OutlinedTextField(
                modifier =Modifier.weight(1f), // étendre la page lors du remplissage de la zone de recherche
                value = city,
                onValueChange ={
...
fun WeatherDetails( data : WeatherModel){
    ...
    Column(modifier = Modifier
        ...
        AsyncImage(model = "https:${data.current.condition.icon}".replace("60x60","120x120"),
