...
public class SplError extends RuntimeException {
    ...
    public static SplError NotAParameter(Position position, Identifier name) { // Traiter des erreurs de parametre non valide
        return new SplError(105, position, "Identifier '%s' does not refer to a parameter.", name);
    }
