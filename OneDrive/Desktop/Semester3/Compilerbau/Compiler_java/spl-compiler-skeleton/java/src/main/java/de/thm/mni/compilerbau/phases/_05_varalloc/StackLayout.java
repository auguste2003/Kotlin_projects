...
public class StackLayout {
    ...
    public Integer argumentAreaSize = null; // Für jedes Argument gibt es einen offset , die benutzt werden muss
    public Integer localVarAreaSize = null;// Für jede lovale Variable gibt es auch einen Offset
    public Integer outgoingAreaSize = null; // Maximum  an Platzbedarf für die Argumente der aufrufenden Prozeduren
